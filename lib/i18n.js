...
const i18n = {
  ...
  translations: {
    'zh-CN': {
      ...
      'progress.engineCompression': '使用Ghostscript引擎压缩 {percentage}% ({original} → {target})',
    ...
    'zh-TW': {
      ...
      'progress.engineCompression': '使用Ghostscript引擎壓縮 {percentage}% ({original} → {target})',
    ...
    'en': {
      ...
      'progress.engineCompression': 'Using Ghostscript engine to compress {percentage}% ({original} → {target})',
    ...
    'ja': {
      ...
      'progress.engineCompression': 'Ghostscriptエンジンで{percentage}%圧縮中 ({original} → {target})',
